...
class MenuServiceTest {
    ...
    void queryByUserIdShouldReturnAuthorizedMenuTree() {
        ...
        assertThat(menus).extracting(MenuVo::getName).containsExactly("基础管理", "安全认证", "系统管理");
        ...
        assertThat(menus.get(2).getChildren()).extracting(MenuVo::getId).containsExactly("111", "112", "113", "114", "115");
