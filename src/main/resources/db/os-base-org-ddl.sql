...
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
       ...
       (530, 101, 334, now(), now(), 'system', 'system'),
       (531, 101, 335, now(), now(), 'system', 'system'),
...
INSERT INTO base_org_menu (id, parent_id, type, href, icon, name, description, order_num, created_time, updated_time, created_by, updated_by)
VALUES (122, 109, 'MENU', '/sysadmin/configs', 'setting', '系统配置', '{"routeName":"Config","component":"system/config/index","visible":1}', 70, now(), now(), 'system', 'system'),
       (123, 101, 'MENU', '/admin/tenants', 'tenant', '租户管理', '{"routeName":"Tenant","component":"system/tenant/index","visible":1}', 70, now(), now(), 'system', 'system'),
       (130,102,'BUTTON','','','新增用户','{"perm":"sys:user:create"}',1,now(),now(),'system','system'), (131,102,'BUTTON','','','修改用户','{"perm":"sys:user:update"}',2,now(),now(),'system','system'), (132,102,'BUTTON','','','删除用户','{"perm":"sys:user:delete"}',3,now(),now(),'system','system'),
       (133,102,'BUTTON','','','导入用户','{"perm":"sys:user:import"}',4,now(),now(),'system','system'), (134,102,'BUTTON','','','导出用户','{"perm":"sys:user:export"}',5,now(),now(),'system','system'), (135,102,'BUTTON','','','重置用户密码','{"perm":"sys:user:reset-password"}',6,now(),now(),'system','system'),
       (136,103,'BUTTON','','','新增菜单','{"perm":"sys:menu:create"}',1,now(),now(),'system','system'), (137,103,'BUTTON','','','修改菜单','{"perm":"sys:menu:update"}',2,now(),now(),'system','system'), (138,103,'BUTTON','','','删除菜单','{"perm":"sys:menu:delete"}',3,now(),now(),'system','system'),
       (139,104,'BUTTON','','','分配角色权限','{"perm":"sys:role:assign"}',1,now(),now(),'system','system'), (140,105,'BUTTON','','','新增组织','{"perm":"sys:dept:create"}',1,now(),now(),'system','system'), (141,105,'BUTTON','','','修改组织','{"perm":"sys:dept:update"}',2,now(),now(),'system','system'), (142,105,'BUTTON','','','删除组织','{"perm":"sys:dept:delete"}',3,now(),now(),'system','system'),
